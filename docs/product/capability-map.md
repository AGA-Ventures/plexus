...
| ----------------- | ------------------------------------------------- | --------------- | -------------------------------------------------------- |
| Public experience | Pre-launch platform story and route hub           | Controlled      | `/`, localized public pages, `/app`, shared navigation   |
| Public experience | Pre-event worldwide inquiry and concierge handoff | Controlled      | `/pre-event`, localized country explorer, WhatsApp draft |
